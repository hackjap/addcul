...
public class IndexActivity4 extends AppCompatActivity {
    ...
    private DatabaseReference conditionRef = databaseReference.child("vat");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_index_activitiy4);
        ...
        if (firebaseUser == null) { // 로그인 상태가 아닐때
            ...
            adapter = new RealChatAdapter(IndexActivity4.this,chatInfos,memberInfos);
            recyclerView.setLayoutManager(new LinearLayoutManager(IndexActivity4.this));
