...
public class IndexActivity6 extends AppCompatActivity {
    ...
    private DatabaseReference conditionRef = databaseReference.child("etc");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (firebaseUser == null) { // 로그인 상태가 아닐때
            ...
            adapter = new RealChatAdapter(IndexActivity6.this,chatInfos,memberInfos);
            recyclerView.setLayoutManager(new LinearLayoutManager(IndexActivity6.this));
